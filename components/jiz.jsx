    ...
    return(
      ...
      <div class="flex flex-row justify-between my-5">
        ...
        <div class="shadow-lg rounded-lg">
          <a href="#">
            <img src="https://htmldemo.net/phuler/phuler/assets/img/product/product-5.jpg" />
          </a>
          <div class="p-5">
        ...
        <div class="shadow-lg rounded-lg">
        <a href="#">
          <img src="https://htmldemo.net/phuler/phuler/assets/img/product/product-6.jpg" class="rounded-tl-lg rounded-tr-lg" />
        </a>
        <div class="p-5">
      ...
      <div class="shadow-lg rounded-lg">
        <a href="#">
          <img src="https://htmldemo.net/phuler/phuler/assets/img/product/product-7.jpg" class="rounded-tl-lg rounded-tr-lg" />
        </a>
        <div class="p-5">
          <h3><a href="#">Nike Shoes</a></h3>
          <div class="flex flex-row my-3">
      ...
      <div class="shadow-lg rounded-lg">
        <a href="#">
          <img src="https://htmldemo.net/phuler/phuler/assets/img/product/product-8.jpg" class="rounded-tl-lg rounded-tr-lg" />
        </a>
        <div class="p-5">
          <h3><a href="#">Nike Shoes</a></h3>
          <div class="flex flex-row my-3">
